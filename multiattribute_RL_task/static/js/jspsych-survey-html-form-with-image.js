/**
 * jspsych-survey-html-form-with-image
 * a jspsych plugin for free html forms
 *
 * Jan Simson
 * Modified by Angela Radulescu to take in image parameter 
 *
 * documentation: docs.jspsych.org
 *
 */

jsPsych.plugins['survey-html-form-with-image'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'survey-html-form-with-image',
    description: '',
    parameters: {
      html: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // show image
    html += '<img id="survey-html-form-with-image" class="survey-html-form-with-image" src="'+trial.stimulus+'"></img>';
