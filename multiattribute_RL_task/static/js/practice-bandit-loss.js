jsPsych.plugins['practice-bandit-loss'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'practice-bandit-loss',
    parameters: {
    sound_paths: {
  ...
  plugin.trial = function(display_element, trial) {
   ...
   // display.photodiode_path = trial.photodiode_paths[0];
    ...
    function DrawBackground(){
      ...
      ctx.fillStyle = "grey";
      ctx.textAlign = "center";
      var info_text_1 = "Pick the square gems."
      var info_text_2 = ""
    ...
    function AfterResponse(info) {
     ...
     if (response.key_char == trial.left_key){
      ...
      counter.training_loss_rewards = counter.training_loss_rewards + response.feedback;
