jsPsych.plugins['practice-bandit'] = (function() {
...
//      iti_duration: {
  ...
  plugin.trial = function(display_element, trial) {
	...
	var photodiode_square = trial.photodiode_paths[0];
	
	var photodiode_clear = trial.photodiode_paths[1];
   ...
   // display.photodiode_path = trial.photodiode_paths[0];
    ...
    function AfterResponse(info) {
     ...
     if (response.key_char == trial.left_key){
      ...
      counter.training_rewards = counter.training_rewards + response.feedback;
